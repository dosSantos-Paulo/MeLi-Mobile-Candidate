...
import com.dossantos.melimobilecandidate.ui.home.HomeViewModel.Companion.OfferUiState.UiState.OnError
import com.dossantos.melimobilecandidate.ui.home.HomeViewModel.Companion.OfferUiState.UiState.OnSuccess
...
class HomeFragment : BaseFragment<FragmentHomeBinding>() {
    ...
    private fun observeOffers() = viewModel.offerUiState.observe(viewLifecycleOwner, ::onOffers)

    private fun onOffers(observable: OfferUiState) = when (val uiState = observable.uiState) {
        is OnSuccess -> showOffers(uiState.offers)
        is OnError -> viewModel.retryOffer()
        else -> ElseNothing
    }
